...
namespace Scripts
{
    partial class Parts
    {
        ...
        private AmmoDef ImpulseRound => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Impulse",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 4f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 0.00000000000001f,
            Mass = 0, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 300000f,
            DecayPerShot = 99999999999999,
             ...
             AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = .4f,
                        Color = Color(red: 25, green: 25f, blue: 3, alpha: 1f),
                        VisualFadeStart = 600, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 400, // How many ticks after fade began before it will be invisible.
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 25, green: 25, blue: 3, alpha: 0.75f),
                            WidthMultiplier = 1f,
                            Reverse = false,
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 50,
                        Color = Color(red: 55, green: 55f, blue: 15, alpha: 1f),
                        Back = true,
                        CustomWidth = 0,
