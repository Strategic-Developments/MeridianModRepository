...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition ImpulseGunUp => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "TorpImpulseGunUp", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Impulse Gun Up", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
