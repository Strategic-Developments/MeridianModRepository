...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition ImpulseGunForwards => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "TorpImpulseGunForwards", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 5500, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
                ...
                StopTrackingSpeed = 0f, // Do not track threats traveling faster than this speed; 0 = unlimited.
            },
            HardPoint = new HardPointDef
            {
                PartName = "Impulse Gun Forwards", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.00f, // Projectile inaccuracy in degrees.
                ...
                Loading = new LoadingDef
                {
                    ...
                    DropTargetUntilLoaded = false, // Maximum number of reloads in the LIFETIME of a weapon
                },
                Audio = new HardPointAudioDef
                {
                    PreFiringSound = "", // Audio for warmup effect.
                    FiringSound = "lasersfx", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "OxyLeakLarge", // SubtypeId of muzzle particle effect.
