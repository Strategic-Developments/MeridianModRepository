...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxPDRailgunTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXPicketRailgun",
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 100, // Constant base power draw in MW.
                ...
                {
                    RateOfFire = 120, // Set this to 3600 for beam weapons.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXSmallRailgunFire", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "",
                    NoAmmoSound = "",
                    HardPointRotationSound = "", // Audio played when turret is moving.
                    BarrelRotationSound = "",
                    FireSoundEndDelay = 300, // How long the firing audio should keep playing after firing stops. Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                },
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef
                    {
                        ...
                        Extras = new ParticleOptionDef
                        {
                            ...
                            MaxDistance = 150, // Max distance at which this effect should be visible. NOTE: This will use whichever MaxDistance value is higher across Effect1 and Effect2!
                    ...
                    {
                        Name = "",
                        Color = Color(red: 10, green: 8, blue: 1, alpha: 1),
            ...
            Ammos = new[] {
                AryxPDRailgunAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = AryxPDRailgunAnims,
