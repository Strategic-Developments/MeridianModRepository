...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxRailgun => new WeaponDefinition
        {
            ...
            {
                PartName = "Artemis 250mm Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                AryxRailgunAmmoWC, // Must list all primary, shrapnel, and pattern ammos.
            },
