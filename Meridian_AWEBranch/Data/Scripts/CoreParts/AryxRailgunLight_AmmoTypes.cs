...
using static Scripts.Structure.WeaponDefinition.AmmoDef.FragmentDef.TimedSpawnDef;
...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxPDRailgunAmmo => new AmmoDef
        {
            ...
            EnergyCost = 0, //1125f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 200, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
                ...
                Armor = new ArmorDef
                {
                    ...
                    Light = 0.1f, // Multiplier for damage against light armor.
                    Heavy = 0.01f, // Multiplier for damage against heavy armor.
