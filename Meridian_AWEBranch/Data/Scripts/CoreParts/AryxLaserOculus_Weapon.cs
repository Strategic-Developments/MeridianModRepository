...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AryxEyeballLaser => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 15000, // 0 = unlimited, Maximum target distance that targets will be automatically shot at.
            ...
            {
                PartName = "Oculus Ball-PDL", // name of weapon in terminal
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 20, //10 heat generated per shot
                    MaxHeat = 4800, //max heat before weapon enters cooldown (70% of max heat)
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "ArcWepShipARYXOCULUS_Fire", // WepShipGatlingShot
                    FiringSoundPerShot = false,
                    ReloadSound = "",
                    NoAmmoSound = "",
                    HardPointRotationSound = "WepTurretGatlingRotate",
                    BarrelRotationSound = "",
                    FireSoundEndDelay = 1, // Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                },
