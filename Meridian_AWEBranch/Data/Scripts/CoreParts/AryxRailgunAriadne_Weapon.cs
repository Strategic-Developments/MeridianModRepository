...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AryxGaussTurret => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXGaussTurret",
                        SpinPartId = "None",
            ...
            Targeting = new TargetingDef  
            {
                ...
                MaxTargetDistance = 60000, // 0 = unlimited, Maximum target distance that targets will be automatically shot at.
            ...
            HardPoint = new HardPointDef 
            {
                ...
                Audio = new HardPointAudioDef {
                    ...
                    FiringSound = "ArcWepShipARYXGauss_Fire", // WepShipGatlingShot
            ...
            Animations = AryxGaussTurretAnims,
