...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Flak76 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "GreenAmmoMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Flak", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1000, // Direct damage; one steel plate is worth 100.
            Mass = 1f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 2000f, // Recoil. This is applied to the Parent Grid.
            ...
            {
                AmmoRound = "fragment_76", // AmmoRound field of the ammo to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    Proximity = 55f, // Starting distance from target bounding sphere to start spawning fragments, 0 disables this feature.  No spawning outside this distance
                    ParentDies = true, // Parent dies once after it spawns its last child.
                    PointAtTarget = true, // Start fragment direction pointing at Target
                    PointType = Lead, // Point accuracy, Direct, Lead (always fire), Predict (only fire if it can hit)
                    DirectAimCone = 200f, //Aim cone used for Direct fire, in degrees
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    ...
                    NonArmor = -0.01f, // Multiplier for damage against every else.
                },
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "Explosion_AmmunitionTiny", // Particle SubtypeID, from your Particle SBC
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 2700, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 20000, // voxel phasing if you go above 5100
                MaxTrajectory = 50000f, // Max Distance the projectile or beam can Travel.
            ...
            {
                ModelName = "\\Models\\Cubes\\Sabot250.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 25, //
                        Width = 1f, //
                        Color = Color(red: 5, green: 4, blue: 3, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 15, green: 14, blue: 14, alpha: 1),
                        Back = false,
                        CustomWidth = 0.5f,
         ...
         private AmmoDef fragment_76 => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "fragment_76", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                Degrees = 3600, // Cone in which to randomise direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
            },
            Pattern = new PatternDef
            {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Grids = new GridSizeDef
                {
                    Large = 0.00001f, // Multiplier for damage against large grids.
                    Small = 9999f, // Multiplier for damage against small grids.
                },
                Armor = new ArmorDef
                {
                    Armor = 1.0f, // Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
                    Light = 1f, // Multiplier for damage against light armor.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = true,
                    ParticleScale = 1,
                    CustomParticle = "MissileExplosion_M1",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "", //ShipWelderArc Exp_Spark_Shockwave
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 0.3f,
                        Color = Color(red: 2, green: 2, blue: 0, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "ProjectileTrailLine",
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 120,
                        Color = Color(red: 5, green: 2, blue: 0, alpha: 1),
                        Back = false,
                        CustomWidth = 0.3f,
                        UseWidthVariance = false,
                        UseColorFade = true,
