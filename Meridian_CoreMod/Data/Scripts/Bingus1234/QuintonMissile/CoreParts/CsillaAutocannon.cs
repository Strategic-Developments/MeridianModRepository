    ...
    partial class Parts {
        ...
        WeaponDefinition CsillaAutocannon => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 35000, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                   RateOfFire = 2000, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    MaxHeat = 9999, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = .95f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 5000, // Amount of heat lost per second.
                    DegradeRof = false, // Progressively lower rate of fire when over 80% heat threshold (80% of max heat).
                    ShotsInBurst = 240, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "cannonburst2", // Audio for firing.
                    ...
                    FireSoundEndDelay = 360, // How long the firing audio should keep playing after firing stops. Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
