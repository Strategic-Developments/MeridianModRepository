...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef MCRNLightRailgunSabot => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "Stiletto/Dagger Railgun Sabot", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
           ...
           // Maximum amount of pen damage to apply per block hit.  Deducts from BaseDamage and uses DamageScales modifiers
            ...
            BackKickForce = 240000f, // Recoil. This is applied to the Parent Grid.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 50000, // Max Distance the projectile or beam can Travel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1000f,
                        Width = 0.6f,
                        Color = Color(red: 20, green: 25, blue: 30, alpha: 1),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 30,
                        Color = Color(red: 11, green: 16, blue: 25, alpha: 0.75f),
                        Back = false,
                        CustomWidth = 0.4f,
