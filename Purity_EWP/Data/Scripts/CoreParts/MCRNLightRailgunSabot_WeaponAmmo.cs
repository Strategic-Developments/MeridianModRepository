...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef MCRNLightRailgunSabot => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "MCRNRailgunSabotAmmo_Magazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MCRNLightRailgunSabot", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
           ...
           // Maximum amount of pen damage to apply per block hit.  Deducts from BaseDamage and uses DamageScales modifiers
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "MCRNLightRailgunSabotBonusDamage",
                },
                Enable = true,
                TriggerChance = 1f,
                Random = false,
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    ...
                    Light = 0.125f, // Multiplier for damage against light armor.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = true,
                    ParticleScale = 1,
                    CustomParticle = "EWP_Railgun_hit", // Particle SubtypeID, from your Particle SBC
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 30000f, // voxel phasing if you go above 5100
                MaxTrajectory = 120000f, // Max Distance the projectile or beam can Travel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "", //ShipWelderArc
                        Color = Color(red: 20f, green: 20f, blue: 30f, alpha: 1),
        ...
        private AmmoDef MCRNLightRailgunSabotBonusDamage => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MCRNLightRailgunSabotBonusDamage", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            ObjectsHit = new ObjectsHitDef
            {
                MaxObjectsHit = 1, // Limits the number of grids or projectiles that damage can be applied to, useful to limit overpenetration; 0 = unlimited.
                CountBlocks = true, // Counts individual blocks, not just entities hit.  Note that every block touched by primary damage hits will count toward MaxObjectsHit
                SkipBlocksForAOE = false, //If CountBlocks = true this will determine if AOE hits are counted against MaxObjectsHit.  Set true to skip counting for AOE
            },
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    CustomSound = "EWPRailgun_Impact", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond
                },
            },
            Ewar = new EwarDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 9000f, // voxel phasing if you go above 5100
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                ShotSound = "MCRNLightRailgun_Shot",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
