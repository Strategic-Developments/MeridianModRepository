...
namespace Scripts
{
    partial class Parts
    {
        private AnimationDef OPAAutocannonPDC_Animations => new AnimationDef
        {
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("Barrel1"), //Remember to remove subpart_ from these names!
                               ...
                               new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0f, 0, 0.2f), //linear movement in XYZ axes.
                                    },
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("Barrel2"), //Remember to remove subpart_ from these names!
