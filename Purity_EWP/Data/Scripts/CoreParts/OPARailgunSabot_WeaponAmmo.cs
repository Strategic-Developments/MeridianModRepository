...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef OPARailgunSabot => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "BelterRailgunSabotAmmo_Magazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "DEFAULT OPARailgunSabot", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 10f, green: 7f, blue: 5f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.1f,
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "EWPRailgun_Impact",
                FloatingHitSound = "",
                HitPlayChance = 1f,
                HitPlayShield = true,
            },
        ...
        private AmmoDef OPARailgunSabotOC => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "BelterRailgunSabotAmmo_Magazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "OVERCLOCKED OPARailgunSabot", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            ...
            Mass = 10f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 3000000f, // Recoil. This is applied to the Parent Grid.
            DecayPerShot = 4000f, // Damage to the firing weapon itself.
            HardPointUsable = true, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            EnergyMagazineSize = 1, // For energy weapons, how many shots to fire before reloading.
            IgnoreWater = false, // Whether the projectile should be able to penetrate water when using WaterMod.
            IgnoreVoxels = false, // Whether the projectile should be able to penetrate voxels.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "ChargedLightning1", "ChargedLightning2",
                },
                Enable = true,
                TriggerChance = 1f,
                Random = false,
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossDegree = 80f, // Degrees, Is pointed forward
                TargetLossTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = (int)(((10000d/9000d)*60d)-1d), // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 10000f, // voxel phasing if you go above 5100
        ...
        private AmmoDef ChargedLightning1 => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "ChargedLightning1",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1000f,
                        Width = 0.05f,
                        Color = Color(red: 25.0f, green: 25.20f, blue: 40.0f, alpha: 0.8f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
                        ...
                        DecayTime = 25,
                        Color = Color(red: 8.985f, green: 8.162f, blue: 40.81f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.3f,
        ...
        private AmmoDef ChargedLightning2 => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "ChargedLightning2",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 0f, // in kilograms
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 500f,
                        Width = 0.03f,
                        Color = Color(red: 30.0f, green: 25.20f, blue: 18.0f, alpha: 0.7f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
                    ...
                    OffsetEffect = new OffsetEffectDef
                    {
                        MaxOffset = 1.3,// 0 offset value disables this effect
                        MinLength = 1.2f,
                        MaxLength = 14,
                    },
                },
