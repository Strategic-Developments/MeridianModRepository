...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition MCRNHeavyRailgunTurret_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MCRNHeavyRailgunTurret_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 20000, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
                MinTargetDistance = 0, // Minimum distance at which targets will be automatically shot at.
                TopTargets = 12, // Maximum number of targets to randomize between; 0 = unlimited.
                CycleTargets = 0, // Numbert of targets to cycle through per aquire attempt
                TopBlocks = 24, // Number of potential block targets to randomize, then go in list order; 0 = no randomization, goes in order of internal lists for block subtypes found
            ...
            {
                PartName = "MCRN heavy railgun turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 1.0f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 1100f, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayUntilFire = 100, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "MCRNHeavyRailgun_Charge", // Audio for warmup effect. ArcWepRailgunSmallCharge
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Muzzle_Flash_MCRNHeavyRailgun", // SubtypeId of muzzle particle effect.
                        Color = Color(red: 1, green: 1, blue: 1, alpha: 1), // Deprecated, set color in particle sbc.
                        Offset = Vector(x: 0, y: 0, z: -1), // Offsets the effect from the muzzle empty.
            ...
            Ammos = new[] {
                MCRNHeavyRailgunSabot, MCRNHeavyRailgunSabotBonusDamage,
            // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = HeavyRailgunTurretAnimation,
