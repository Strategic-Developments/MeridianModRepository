...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition MCRNLightRailgunFixed_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MCRNLightRailgunFixed_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "MCRN light railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 2f, // Constant base power draw in MW.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Muzzle_Flash_MCRNLightRailgun", // SubtypeId of muzzle particle effect.
            ...
            Animations = MCRNLightRailgunAnimation,
