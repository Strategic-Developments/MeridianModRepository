...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef DawsonAPRailgunSabot => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "Armour-Piercing Railgun Sabot", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
           ...
           // Maximum amount of pen damage to apply per block hit.  Deducts from BaseDamage and uses DamageScales modifiers
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 20000f, // voxel phasing if you go above 5100
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 5f, green: 9f, blue: 18f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.2f,
