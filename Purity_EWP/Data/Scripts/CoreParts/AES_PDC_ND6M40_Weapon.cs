...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AES_6M40_PDC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Aryx_AES_6M40_PDC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "ND-6M40 PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    Offset = Vector(x: 0.95f, y: 0, z: 0), // Offsets the aiming/firing line of the weapon, in metres.
                ...
                Other = new OtherDef
                {
                    ...
                    RestrictionRadius = 3.5, // Prevents other blocks of this type from being placed within this distance of the centre of the block.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "AES_PDC_ND6M40_FireClose", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "KONTAKT_AUDIO_30mm_RELOAD_1", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Aryx_AES_6M40_Muzzle", // SubtypeId of muzzle particle effect.
