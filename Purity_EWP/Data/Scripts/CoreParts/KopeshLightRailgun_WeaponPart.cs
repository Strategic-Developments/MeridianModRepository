...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition KopeshLightRailgun_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "KopeshLightRailgun_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "S24 Kopesh light railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 210, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "Kopesh_Charge", // Audio for warmup effect. ArcWepRailgunSmallCharge
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Muzzle_Flash_KopeshRailgun", // SubtypeId of muzzle particle effect.
            ...
            Animations = KopeshLightRailgunAnimation,
