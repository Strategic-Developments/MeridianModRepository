...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition OPADecoyDispenser_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "OPADecoyDispenser_Block", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_missile_1", "muzzle_missile_2", "muzzle_missile_3", "muzzle_missile_4", "muzzle_missile_5", "muzzle_missile_6", "muzzle_missile_7", "muzzle_missile_8", "muzzle_missile_9", "muzzle_missile_10", "muzzle_missile_11", "muzzle_missile_12", "muzzle_missile_13", "muzzle_missile_14", "muzzle_missile_15", "muzzle_missile_16", "muzzle_missile_17", "muzzle_missile_18", "muzzle_missile_19", "muzzle_missile_20", "muzzle_missile_21", "muzzle_missile_22", "muzzle_missile_23", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            Targeting = new TargetingDef  
            {
                ...
                MinimumDiameter = 0.5f, // 0 = unlimited, Minimum radius of threat to engage.
                ...
                StopTrackingSpeed = 3000, // do not track target threats traveling faster than this speed
            },
            HardPoint = new HardPointDef
            {
                PartName = "Decoy Dispenser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 0, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -0,
                    MaxAzimuth = 0,
                    MinElevation = -0,
                    MaxElevation = 0,
                ...
                Loading = new LoadingDef
                {
                    ...
                    MagsToLoad = 23, // Number of physical magazines to consume on reload.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "WepPlayFlarePistolShot", // Audio for firing.
            ...
            //Animations = OPADecoy_Animations,
