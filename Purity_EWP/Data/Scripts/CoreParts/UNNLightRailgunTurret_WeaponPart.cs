...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition UNNLightRailgunTurret_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "UNNLightRailgunTurret_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "UNN light railgun turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 500f, // Constant base power draw in MW.
                ...
                {
                    RateOfFire = 35, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 400, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "DawsonRailgun_Charge", // Audio for warmup effect. ArcWepRailgunSmallCharge
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Muzzle_Flash_EWPLightRailgunTurret", // SubtypeId of muzzle particle effect.
                        Color = Color(red: 1, green: 1, blue: 1, alpha: 1), // Deprecated, set color in particle sbc.
                        Offset = Vector(x: 0, y: 0, z: -1.5f), // Offsets the effect from the muzzle empty.
