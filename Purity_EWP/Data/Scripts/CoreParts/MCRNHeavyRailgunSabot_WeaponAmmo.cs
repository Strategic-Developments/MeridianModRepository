...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef MCRNHeavyRailgunSabot => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            BackKickForce = 4000000f, // Recoil. This is applied to the Parent Grid.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "MCRNHeavyRailgunSabotBonusDamage",
                },
                Enable = true,
                TriggerChance = 1f,
                Random = false,
        ...
        private AmmoDef MCRNHeavyRailgunSabotBonusDamage => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MCRNHeavyRailgunSabotBonusDamage", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 300, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 15000f, // voxel phasing if you go above 5100
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                ShotSound = "MCRNHeavyRailgun_Shot",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
