...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition MCRNLightRailgunTurret_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MCRNLightRailgunTurret_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "MCRN light railgun turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 300f, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 160, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "ArcWepRailgunSmallCharge", // Audio for warmup effect. ArcWepRailgunSmallCharge
            ...
            Ammos = new[] {
                MCRNLightRailgunSabot, MCRNLightRailgunSabotBonusDamage,
