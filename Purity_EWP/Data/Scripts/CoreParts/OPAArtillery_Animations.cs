...
namespace Scripts
{
    partial class Parts
    {
        private AnimationDef OPAArtillery_Animations => new AnimationDef
        {
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("recoil1"), //Remember to remove subpart_ from these names!
                               ...
                               new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0f, 0, 0.5f), //linear movement in XYZ axes.
                                    },
