...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition OPAPrototypeRailgun_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "OPAPrototypeRailgun_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "OPA Prototype railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 25000, // Heat generated per shot.
                ...
                {
                    PreFiringSound = "BelterRailgun_Charge", // Audio for warmup effect. ArcWepRailgunSmallCharge
                    FiringSound = "BelterRailgun_Shot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Muzzle_Flash_BelterRailgun", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                OPARailgunSabot, OPARailgunSabotOC, ChargedLightning1, ChargedLightning2,
            // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = OPAPrototypeRailgunAnimation,
