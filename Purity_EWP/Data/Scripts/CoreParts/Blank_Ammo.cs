...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef BlankTargeting_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "BlankTargeting_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                FallOff = new FallOffDef
                {
                    ...
                    MinMultipler = 0.0001f, // Value from 0.0001f to 1f where 0.1f would be a min damage of 10% of base damage.
                },
