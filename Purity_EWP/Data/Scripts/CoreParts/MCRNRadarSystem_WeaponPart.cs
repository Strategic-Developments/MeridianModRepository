...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MCRNRadarSystem_Primary => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    ...
                    new MountPointDef {
                        SubtypeId = "MCRNRadarSystem_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Offense, Utility, Power, Production, Thrust, Jumping, Steering, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "MCRN Radar Primary", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
