...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef OPA75mmTimedFuze => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "OPAFlak_Magazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "75mm Flak Round", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "OPA75mmShrapnel", // AmmoRound field of the ammo to spawn.
                Fragments = 90, // Number of projectiles to spawn.
                Degrees = 60, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = true, // fragments will not inherit velocity from parent.
                Offset = -25f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards), value is read from parent ammo type.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    MaxSpawns = 150, // Max number of fragment children to spawn
                    Proximity = 25, // Starting distance from target bounding sphere to start spawning fragments, 0 disables this feature.  No spawning outside this distance
                    ...
                    GroupSize = 150, // Number of spawns in each group
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Grids = new GridSizeDef
                {
                    ...
                    Small = 5f, // Multiplier for damage against small grids.
                },
                Armor = new ArmorDef
                {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 150, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 15000, // voxel phasing if you go above 5100
                ...
                RangeVariance = Random(start: 250, end: 250), // subtracts value from MaxTrajectory
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 250f, //
                        Width = 0.5f, //
                        Color = Color(red: 7f, green: 6, blue: 6f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 6f, green: 5f, blue: 4f, alpha: 0.5f),
                        Back = false,
                        CustomWidth = 0.25f,
        ...
        private AmmoDef OPA75mmShrapnel => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "OPA75mmShrapnel", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 10000f, // voxel phasing if you go above 5100
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 100f, //
                        Width = 0.05f, //
                        Color = Color(red: 2, green: 2, blue: 2, alpha: 0.5f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
