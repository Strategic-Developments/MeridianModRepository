...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AES_6M40_Primary => new AmmoDef // Your ID for slotting into the Weapon CS
        {
            AmmoMagazine = "AES_NARIMAN_40MM_AMMOMAGAZINE", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MCRN 600-77x40mm AP", // Name of ammo in terminal. This should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BaseDamage = 330, // Direct damage; one steel plate is worth 100.
            Mass = 3.24f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 400, // Recoil. This is applied to the Parent Grid.
            ...
            {
                MaxIntegrity = 0, // Blocks with integrity higher than this value will be immune to damage from this projectile; 0 = disabled.
                ...
                Characters = 85, // Character damage multiplier; defaults to 1 if zero or less.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 1800, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                ...
                MaxTrajectory = 40000, // Max Distance the projectile or beam can Travel.
            ...
            {
                ModelName = "", // Model Path goes here. \\Models\\Items\\Ammo\\KGS_30mm_Ammo
                ...
                Lines = new LineDef
                {
                    ...
                    WidthVariance = Random(start: 0.25f, end: 0.5f), // adds random value to default width (negatives shrinks width)
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 20, green: 10, blue: 5, alpha: 1),
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        Back = false,
                        CustomWidth = 0,
