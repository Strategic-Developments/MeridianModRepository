...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MCRNRetractablePDC_Block => new WeaponDefinition
        {
            ...
            {
                PartName = "MCRN PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "PDCShotLooped", // Audio for firing.
