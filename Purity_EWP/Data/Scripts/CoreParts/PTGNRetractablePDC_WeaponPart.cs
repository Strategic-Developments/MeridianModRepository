...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition PTGNRetractablePDC_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    ...
                    new MountPointDef {
                        SubtypeId = "PTGNRetractablePDC_Block", // Block Subtypeid. Your Cubeblocks contain this information
                    ...
                    new MountPointDef {
                        SubtypeId = "PTGNMountedPDC_Block", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "Barrels", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "GatlingTurretBase2", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "GatlingTurretBase1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "GatlingTurretBase2",// Your Elevating Subpart, that bit that moves up
                    ...
                    new MountPointDef {
                        SubtypeId = "PTGNMountedPDCSlope_Block", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "Barrels", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "GatlingTurretBase2", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "GatlingTurretBase1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "GatlingTurretBase2",// Your Elevating Subpart, that bit that moves up
            ...
            {
                Threats = new[] {
                    Projectiles, Meteors, Characters, Grids,
                },
                SubSystems = new[] {
                ...
                MaxTargetDistance = 30000, // 0 = unlimited, Maximum target distance that targets will be automatically shot at.
            ...
            {
                PartName = "Protogen Supercooled Retractable PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 0.13f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.13f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -14,
                    MaxElevation = 90,
                ...
                {
                    RateOfFire = 2400, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    ShotsInBurst = 15, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                    ...
                    BarrelSpinRate = 750, // Visual only, 0 disables and uses RateOfFire.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "PDCShotLoopedV2", // Audio for firing.
                    ...
                    BarrelRotationSound = "PDCBarrelsWindup",
            ...
            Ammos = new[] {
                PTGNRetractablePDC_Ammo, 
                 // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = PTGNRetractablePDC_Animation,
