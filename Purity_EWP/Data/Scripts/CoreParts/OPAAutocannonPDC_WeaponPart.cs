...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition OPAAutocannonPDC_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    ...
                    new MountPointDef {
                        SubtypeId = "OPAAutocannonPDC_Block", // Block Subtypeid. Your Cubeblocks contain this information
                    ...
                    new MountPointDef {
                        SubtypeId = "OPAAutocannonPDCSG_Block", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MissileTurretBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MissileTurretBase1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MissileTurretBarrels",// Your Elevating Subpart, that bit that moves up
            ...
            Targeting = new TargetingDef  
            {
                ...
                MaxTargetDistance = 8000, // 0 = unlimited, Maximum target distance that targets will be automatically shot at.
            ...
            {
                PartName = "OPA AUTOCANNON PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 0.07f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -25,
                    MaxElevation = 60,
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "EWP_Muzzle_Flash_BelterAutocannon",
            ...
            Ammos = new[] {
                OPAAutocannonPDC_Ammo, 
                 // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = OPAAutocannonPDC_Animations,
