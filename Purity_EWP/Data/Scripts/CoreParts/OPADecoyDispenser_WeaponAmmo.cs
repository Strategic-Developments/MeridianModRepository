...
{ // Don't edit above this line
      partial class Parts
    {
        private AmmoDef OPADecoy_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "OPADecoy_Magazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "OPA Decoy", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                Offset = -10f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards).
            ...
            Ewar = new EwarDef
            {
                ...
                */
                ...
                Field = new FieldDef
                {
                    ...
                    TriggerRange = 1250f, //range at which fields are triggered
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 300f, // voxel phasing if you go above 5100
                ...
                {
                    SteeringLimit = 180, // 0 means no limit, value is in degrees, good starting is 150.  This enable advanced smart "control", cost of 3 on a scale of 1-5, 0 being basic smart.
                    Inaccuracy = 0f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    Aggressiveness = 5f, // controls how responsive tracking is, recommended value 3-5.
                    MaxLateralThrust = 2.0, // controls how sharp the projectile may turn, this is the cheaper but less realistic version of SteeringLimit, cost of 2 on a scale of 1-5, 0 being basic smart.
                    ...
                    TrackingDelay = 7f, // Measured in Shape diameter units traveled.
                    ...
                    OffsetMinRange = 2500, // The range from target at which offsets are no longer active
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        ...
                        Color = Color(red: 1, green: 1, blue: 0.5f, alpha: 1),
                ...
                Lines = new LineDef
                {
                    ...
                    WidthVariance = Random(start: 0f, end: 0.45f), // adds random value to default width (negatives shrinks width)
                    Tracer = new TracerBaseDef
                    {
                        Enable = true,
                        Length = 0.5f, //
                        Width = 0.2f, //
                        Color = Color(red: 100f, green: 10f, blue: 10f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
