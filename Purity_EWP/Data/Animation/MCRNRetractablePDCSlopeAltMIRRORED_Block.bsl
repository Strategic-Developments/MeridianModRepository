@BlockID "MCRNRetractablePDCSlopeAltMIRRORED_Block"
@Version 2
@Author h
@Weaponcore 0
...
using AngleSubpart as Subpart ("AngleSubpart")
using Elevator as Subpart ("Elevator") parent AngleSubpart
using Door1 as Subpart ("Door1") parent AngleSubpart
using Door1Corner1 as Subpart ("Door1Corner1") parent Door1
using Door1Corner2 as Subpart ("Door1Corner2") parent Door1
using Door2 as Subpart ("Door2") parent AngleSubpart
