...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef AryxLightCoilgunAmmoWC => new AmmoDef
        {
            AmmoMagazine = "AryxLightCoilgunAmmo",
			...
			AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    Enable = true,
                    Radius = 3f, // Meters
                    Damage = (float)(15000 * AWEGlobalDamageScalar),
                    Depth = 2f,
                    MaxAbsorb = 0f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 50f,
                        Width = 2f,
                        Color = Color(red: 15, green: 20, blue: 59, alpha: 1),
        ...
        private AmmoDef AryxLightCoilgunAmmoShrapWC => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "AryxLightCoilgunPiercingAmmoWC",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = (float)(21750 * AWEGlobalDamageScalar),
            Mass = 0, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 500f,
            DecayPerShot = 0,
